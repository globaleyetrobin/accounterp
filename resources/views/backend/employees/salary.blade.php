            ...
            <div class="col">
                <div class="table-responsive">
                    <table id="employee_salary" class="table">
                        <thead>
                            <tr>
                                <th>{{ trans('labels.backend.access.employees.table.name') }} : <?php echo $employee->name ?></th>
								 
								 <th>Emp No: <?php echo $employee->id ?></th>
			   ...
			   {{ Form::open(['route' => 'admin.employees.savesalary', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-permission', 'files' => true]) }}		
