...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mt-4 mb-4">
            ...
            <div class="form-group row">
                {{ Form::label('branch_id', trans('validation.attributes.backend.access.branches.name'), ['class' => 'col-md-2 from-control-label required']) }}

                <div class="col-md-10">
                    {{ Form::select('branch_id', $branches, null, ['class' => 'form-control categories box-size', 'data-placeholder' => trans('validation.attributes.backend.access.branches.name'), 'required' => 'required']) }}
                </div>
                <!--col-->
                </div>
            <!--form-group-->
