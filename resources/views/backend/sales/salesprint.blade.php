									...
									<table class="table borderless custom-table" style="border-bottom:solid 1px #ccc">
										<tbody>
											<tr >
												<td width="50%">
												<h5>BILL To:</h5>
												<p class="billdetails"><?php echo $sales->customer_name?></p>
												<p class="billdetails"><?php echo $sales->customer_address?> </p>
												<p class="billdetails"><?php echo $sales->customer_email?>  </p>
												<p class="billdetails"><?php echo $sales->customer_phoneno?> </p>
												
												</td>
												<td width="50%" align="right">
												<h5>INVOICE#:</h5>
												<p class="billdetails"><?php echo $sales->sale_no?></p>
												<p class="billdetails font12px"><strong>DATE:</strong></p>
												<p class="billdetails"><?php echo date('d/m/Y',strtotime($sales->sale_date))?></p>
											...
											if(isset($saleitems))
					                         {
												...
												<tr>
													...
													<td><?php echo $items->saleitems_quantity?></td>
													<td>₹<?php echo $items->saleitems_price?></td>
													<td>₹<?php echo $items->saleitems_actual_amount?></td>
													<td>
													<?php
													 if($items->saleitems_discount_amount !='')
													 {
                                                      ?> 														 
													   ₹
													   <?php
													   echo $items->saleitems_discount_amount;
													 }
													 else
													...
													<td>₹<?php echo $items->saleitems_final_amount?></td>
												</tr>
									...
									<div class="invoice-bottom-total">
										<div class="col-sm-8 no-padding float-left">
											<div class="sub-total-box">
												<h6>SUBTOTAL</h6>
												<h5>₹<?php echo $sales->sale_amount?></h5>
											</div>
											<div class="add-box">
												<h3>-</h3>
											</div>
											<div class="tax-box">
												...
												<h5>₹
												<?php 
												if($sales->sale_discountamount !='')
												{
												echo $sales->sale_discountamount;
												}
												else
												{
													echo "0";
											...
											<div class="tax-box">
												<h6>TAXES</h6>
												<h5>₹<?php echo $sales->sale_taxamount?></h5>
											</div>
										...
										<div class="col-sm-4 no-padding float-left">
											<div class="total-box">
												<h6>TOTAL</h6>
												<h3>₹<?php echo $sales->sale_netamount?></h3>
											</div>
										</div>
									</div>
								</div>
